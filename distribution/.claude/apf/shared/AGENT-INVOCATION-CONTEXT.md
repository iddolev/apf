...
```
.claude/apf/scripts/log_agent_invocation.bat "<your-agent-name>" "agent-start" "<brief description of the task and input you received>" "invocation-id"
```
...
```
.claude/apf/scripts/log_agent_invocation.bat "<your-agent-name>" "agent-stop" "<brief summary of what you did and the outcome so far>" "invocation-id" "<the INVOCATION_ID value you captured>"
```
