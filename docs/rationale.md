...
| READMEs (project-level, module-level, package-level) | **Partially covered** -- project-level README created in preparation phase (`starting-point.md` step 12, `README.md.tmpl`); module/package-level READMEs are not addressed |
...
| Documentation Function | Current Coverage |
|---|---|
| Contributing guides (coding standards, PR process, branch naming) | **Partially covered** -- `GIT-RULES.md.tmpl` covers git conventions; `PROGRAMMING-PRINCIPLES.md` covers coding standards; no unified contributing guide is generated |
...
| Security policies | **Partially covered** -- `SECURITY-CONVENTIONS.md.tmpl` created in preparation phase if needed; does not cover disclosure process or incident response |
