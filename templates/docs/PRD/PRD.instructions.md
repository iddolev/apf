...
which matches the template at `instructions/PRD/PRD.md.tmpl`.
...
- **If the latest PRD is NOT Approved** (i.e., it is Draft or In Review): check
  whether it conforms to the template in `instructions/PRD/PRD.md.tmpl`.
