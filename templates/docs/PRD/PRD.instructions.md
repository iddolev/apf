...
which matches the template at `instructions/PRD/PRD.tmpl.md`.
...
- **If the latest PRD is NOT Approved** (i.e., it is Draft or In Review): check
  whether it conforms to the template in `instructions/PRD/PRD.tmpl.md`.
