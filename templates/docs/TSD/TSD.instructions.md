...
inputs:
  ...
  - "/instructions/TSD/TSD.tmpl.md (reference menu of possible sections)"
outputs:
...
template at `instructions/TSD/TSD.tmpl.md` is a menu of everything a TSD *could*
...
When writing each section, use the TSD-template (`instructions/TSD/TSD.tmpl.md`)
